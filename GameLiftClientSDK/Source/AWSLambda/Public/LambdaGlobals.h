...
#define LOG_NORMAL(Param1)	   							CREATE_LOG_NORMAL(LogAWSLambda, Param1)
#define LOG_VERBOSE(Param1)	   							CREATE_LOG_VERBOSE(LogAWSLambda, Param1)
#define LOG_VERYVERBOSE(Param1)							CREATE_LOG_VERYVERBOSE(LogAWSLambda, Param1)
#define LOG_WARNING(Param1)	   							CREATE_LOG_WARNING(LogAWSLambda, Param1)
#define LOG_ERROR(Param1)	   							CREATE_LOG_ERROR(LogAWSLambda, Param1)
